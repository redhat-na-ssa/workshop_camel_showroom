...
Now lets execute another Pipeline to build and deploy our Camel Quarkus app using Openshift Pipelines. Go to the Openshift Console, navigate to Pipelines and click on 