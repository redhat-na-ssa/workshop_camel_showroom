...
* To make sure you're logged with the right user, run `oc whoami`. Expected to see `{user}`. If you are not logged, you can follow the steps in the xref:module-03.adoc[troubleshooting guide].
